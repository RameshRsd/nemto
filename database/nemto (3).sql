...
(1, 'Xanthus Pitts', 'Hoffman and Doyle Traders', 'https://www.rog.us', 'Alias quasi sed dolo', '+1 (772) 669-4729', '4545', 'Ipsam labore et in e', 'Reprehenderit ea odi', 'nipuwogijo@mailinator.net', 'Roach Noel LLC', 'active', '2019-07-13 03:12:45', '2019-07-14 23:13:37');
...
(1, 'Mrs', 'Miles Pitts Traders', 'Marny', 'Scott', 'Alias deserunt aliqu', '88 West Second Parkway', 'Soluta asperiores te', '1', '2', '39', 'Facere ullamco sit', '+1 (738) 181-5072', '4564472', 'gifyc@mailinator.com', 'nakovyk@mailinator.com', 'https://www.buqivytyvohur.net', 'active', '2019-07-12 22:35:23', '2019-07-14 23:06:22');
...
(1, 'Prof', 'Schneider Burgess Traders', 'Haviva', 'Sawyer', 'Deserunt dicta assum', '59 West Green Milton Extension', 'Corrupti architecto', '1', '2', '4', 'Rerum velit voluptat', '+1 (649) 649-8285', '5445', 'fatakufeby@mailinator.com', 'lobi@mailinator.net', 'https://www.zigor.com.au', 'active', '2019-07-13 00:50:53', '2019-07-14 23:09:51');
...
(1, 'Ramirez Page Traders', 'Ms', 'Cullen', 'Wood', 'Est mollitia consequ', '999 West First Road', 'Voluptas odio rerum', '1', '2', '40', 'Eum nemo proident s', '+1 (495) 739-5172', '67769', 'razenowi@mailinator.net', 'wywasu@mailinator.com', 'https://www.zahoperakaw.ca', 'active', '2019-07-13 02:29:17', '2019-07-14 23:01:53');
...
(1, 'Yes', 'No', 'Male', 'Er', 'Melton', 'Melton', 3, 'NA', 1, 'Padilla and Weiss Inc', 'Nisi quos sit quia v', '205 North Milton Lane', 'Dolorem magnam delen', '1', '2', '4', 'Optio sapiente quas', '+1 (185) 219-7469', '8768', '797889', '676', 'legojicub@mailinator.net', 'https://www.muhysuzedepygyx.org', 'Enim non ut consecte', 'active', '2019-07-13 00:16:19', '2019-07-14 23:07:54'),
(2, 'Yes', 'No', 'Others', 'Mrs', 'Nerea', 'Lynch', 2, NULL, 12, 'Bruce Dickerson Traders', 'Suscipit explicabo', '22 East Clarendon Street', 'Dolorem aut in ipsam', '1', '2', '4', 'Quia velit quia natu', '+1 (203) 373-2205', 'Ducimus quia exerci', '968', 'Do quaerat itaque al', 'manuly@mailinator.net', 'https://www.nutyqyvoki.cm', 'Et beatae repudianda', 'inactive', '2019-07-13 00:17:11', '2019-07-14 23:07:46');
...
(15, '2019_07_15_042253_create_visa_invitations_table', 8);
...
--
-- Table structure for table `visa_invitations`
--

CREATE TABLE `visa_invitations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `company_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `place_of_issue` int(11) DEFAULT NULL,
  ...
  `file` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TermsOfCondition` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `visa_invitations`
--

INSERT INTO `visa_invitations` (`id`, `company_name`, `passport_name`, `nationality`, `date_of_birth`, `email`, `mobile_number`, `country_id`, `website`, `passport_number`, `place_of_issue`, `date_of_issue`, `expiry_date`, `file`, `TermsOfCondition`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Genius Service Nepal Pvt. Ltd.', 'Ramesh Dahal', 'Nepali', '1992-02-23', 'youramesh5@gmail.com', '9856065444', 156, 'http://www.rameshdahal.com', '435433', 156, '2018-02-20', '2022-02-22', NULL, NULL, 'inactive', '2019-07-14 22:54:05', '2019-07-14 22:54:05'),
(2, 'Genius Service Nepal Pvt. Ltd.', 'Ramesh Dahal', 'Nepali', '1992-02-23', 'youramesh5@gmail.com', '9856065444', 156, 'http://www.rameshdahal.com', '976769', 156, '2018-02-20', '2022-03-31', '337b13803a4e2d9debca21505f5a1073.1563165658.jpg', NULL, 'active', '2019-07-14 22:55:58', '2019-07-14 23:15:18');
...
--
-- Indexes for table `visa_invitations`
--
ALTER TABLE `visa_invitations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `visa_invitations`
--
ALTER TABLE `visa_invitations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
