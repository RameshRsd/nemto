...
class ConferenceController extends Controller
{
    ...
    public function conference_speakers_2018(){
        ...
        return view('frontend.pages.conference.conference_speakers_2018',compact('title'));
    }
    public function agenda_programme(){
        $title = 'Conference Speakers 2018  - Nepal Medical Tourism Organization (A non-profitable organization)';
        return view('frontend.pages.conference.agenda_programme',compact('title'));
    }
    public function regional_forum_schedule(){
        ...
        return view('frontend.pages.conference.regional_forum_schedule',compact('title'));
    }
}
